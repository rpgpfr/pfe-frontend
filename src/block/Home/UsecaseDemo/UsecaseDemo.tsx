    ...
    return (
        <section className={styles.section}>
            ...
            <div className={styles.sectionGrid}>
                <HomeCard imageSrc="/images/demo-aide.webp" imageAlt="Image 1">
                    <p className={styles.content}>
                        Retrouvez des aides tout au long de la création !
                    </p>
                </HomeCard>

                <HomeCard imageSrc="/images/demo-easy.webp" imageAlt="Image 1">
                    <p className={styles.content}>
                        Profitez d’une interface intuitive et facile à utiliser !
                    </p>
                </HomeCard>

                <HomeCard imageSrc="/images/demo-glossaire.webp" imageAlt="Image 1">
                    <p className={styles.content}>
